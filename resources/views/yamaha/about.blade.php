...
@section('meta_description', 'NorthStar Yamaha is a family-owned Yamaha Superstore on Brisbane\'s Northside. Learn about our dealership, owners Michael and Lisa Edwards, and our history.')
...
@section('content')
    ...
    <div class="bg-ink border-b-2 border-brand">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            ...
            <h1 class="text-4xl font-black uppercase text-white tracking-tight">About NorthStar Yamaha</h1>
            ...
            <div class="lg:col-span-2 space-y-12">
                ...
                <section>
                    ...
                    <div class="prose prose-gray max-w-none text-gray-600 leading-relaxed space-y-4">
                        <p>
                            NorthStar Yamaha is a Yamaha Superstore, a family business located on Brisbane's Northside and privately owned by
                        ...
                        <p>
                            Every staff member at NorthStar Yamaha is a motorcycle or WaveRunner enthusiast; when Michael isn't on a bike, he's out on the water enjoying the Yamaha lifestyle.
                        </p>
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div class="prose prose-gray max-w-none text-gray-600 leading-relaxed space-y-4">
                        <p>
                            ...
                            competitive energy directly into running NorthStar Yamaha. His passion for motorsport shapes everything we do, from the
                ...
                <section id="find-us">
                    ...
                    <div class="rounded-xl overflow-hidden border border-gray-200 shadow-sm" style="height:400px;">
                        <iframe
                            ...
                            title="NorthStar Yamaha on OpenStreetMap"
