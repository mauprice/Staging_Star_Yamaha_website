...
<div class="wrapper">
    ...
    <div class="body">
        ...
        <p>{{ $order->isPickup() ? 'Thanks for picking up your order — this one\'s all done.' : 'Your order is complete. Thanks for shopping with us.' }}</p>
        <table class="items">
        ...
        <p>If anything isn't right, just reply to this email and we'll sort it out.</p>
    </div>
    <div class="footer">
