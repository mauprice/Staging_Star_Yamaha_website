...
<div class="dv-wrap">
    ...
    <div class="dv-card">
        ...
        <div class="dv-card-header">
            <h3>Honda Product Categories</h3>
            <p>Turn Honda product categories on or off across the site. Hiding a category removes it (and its subcategories) from the nav menu and the Honda Products landing page — the category's pages still work if someone has a direct link, they just won't be promoted anywhere.</p>
        </div>
        ...
        <div class="dv-row">
            ...
            <label class="dv-switch">
                <input type="checkbox" wire:model.live="{{ $category['property'] }}">
